...
CREATE TABLE exercises(
    ...
    createdAt timestamp default now(),
    updatedAt timestamp,
    FOREIGN KEY (exercise_plan_id) REFERENCES exercise_plans(exercise_plan_id) ON UPDATE CASCADE ON DELETE RESTRICT
);
CREATE TABLE exercise_details(
    ...
    createdAt timestamp default now(),
    updatedAt timestamp,
    FOREIGN KEY (exercise_id) REFERENCES exercises(exercise_id) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
CREATE TABLE workout_exercises(
    ...
    updatedAt timestamp,
    FOREIGN KEY (exercise_id) REFERENCES exercises(exercise_id) ON UPDATE CASCADE ON DELETE RESTRICT,
    FOREIGN KEY (workout_id) REFERENCES workouts(workout_id) ON UPDATE CASCADE ON DELETE RESTRICT
);
/*
